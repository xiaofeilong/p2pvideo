...
public class VideoViewPlayingActivity extends Activity implements OnPreparedListener, 
							...
							{
	private final String TAG = "vbyte VideoViewPlayingActivity";
	
	/**
	 * 您的ak 
	 */
	private String AK = "your AK";
	/**
	 * 您的sk的前16位
	*/
	private String SK = "your SK";
	...
	class EventHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case EVENT_PLAY:
				...
				//切换频道
				if(mChangeChannel) {
					Log.v(TAG, "VodController.getInstance().load()");
					VodController.getInstance().load("your video url", "UHD", 0);
					mChangeChannel = false;
				}
